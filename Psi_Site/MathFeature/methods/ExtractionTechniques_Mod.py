...
if __name__ == '__main__':
    ...
    parser.add_argument('-t', '--type', help='Type of Feature Extraction, NAC or DNC or TNC or kmer or kstep')
    parser.add_argument('-seq', '--seq', help='type of sequence, 1 = DNA and 2 = RNA')
    parser.add_argument('-k', '--kmer', help='Frequency of k-mer (e.g., 3, 4) only for types: kmer, rckmer, kstep')
    parser.add_argument('-w', '--window', help='Sliding Window (e.g., 30, 40), only for types: kstep')
    parser.add_argument('-s', '--step', help='Window Step (e.g., 3, 4), only for types: kstep')
