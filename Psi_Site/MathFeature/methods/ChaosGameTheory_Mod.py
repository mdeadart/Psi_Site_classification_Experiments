...
if __name__ == "__main__":
    ...
    parser.add_argument('-l', '--label', help='Fasta format input file label')
    parser.add_argument('-f', '--frequency', help='Frequency of k-mer (e.g., 3, 4)')
    ...
    dataset_labels[str(args.input)] = str(args.label)
    if check_files() == 1:
